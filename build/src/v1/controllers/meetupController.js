  ...
  (0, _createClass3.default)(meetupController, null, [{
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 14:
                ...
                return _context3.abrupt('return', _helper2.default.errorResponse(response, { status: _context3.t0.status, error: _context3.t0.message }));
    ...
    value: function destroy(request, response) {
      if (request.user.isadmin) {
        ...
        return _helper2.default.errorResponse(response, { status: 401, message: 'You are not authorized to perform this action' });
      }
    }
  }]);

...
class Vote {
  static find(newVote) {
    ...
    return new Promise((resolve, reject) => {
      Querybuilder.run(statement, [question_id, user_id])
  ...
  static record(voteType, newVote) {
    ...
    return new Promise((resolve, reject) => {
      Querybuilder.run(statement, [user_id, question_id, ...weight.split(',')])
        .then(response => resolve(response))
        .catch(error => reject(error));
    });
  }
  ...
  static remove(newVote) {
    ...
    return new Promise((resolve, reject) => {
      Querybuilder.run(statement, [user_id, question_id])
        .then(response => resolve(response))
        .catch(error => reject(error));
    });
  }
